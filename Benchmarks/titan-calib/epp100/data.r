...
mainDir <- "/home/legacy/CMT-bone-BE/NGEE/tst-2016/titan-calib/epp100"
outDir <- "titan-out-epp100"
...
#pdf("titan-calib-epp100.pdf")
jpeg(file="titan-calib-epp100-means.jpg", quality=100)

par( mfrow=c(3,2) )
plot(means$dr_mean, type="p", xlab= "element size", ylab= "avg. execution time/timestep", main= "Mean exectuion time for \"Dr\" - Titan", pch = 19, cex =0.9, frame.plot=1,col="blue")
plot(means$ds_mean, type="p", xlab= "element size", ylab= "avg. execution time/timestep", main= "Mean execution time for \"Ds\" - Titan", pch = 19, cex =0.9, frame.plot=1,col="blue")
plot(means$dt_mean, type="p", xlab= "element size", ylab= "avg. execution time/timestep", main= "Mean execution time for \"Dt\" - Titan", pch = 19, cex =0.9, frame.plot=1,col="blue")
plot(means$conv_mean, type="p", xlab= "element size", ylab= "avg. execution time/timestep", main= "Mean execution time for \"Conv\" - Titan", pch = 19, cex =0.9, frame.plot=1,col="blue")
plot(means$sum_mean, type="p", xlab= "element size", ylab= "avg. execution time/timestep", main= "Mean execution time for \"Sum\" - Titan", pch = 19, cex =0.9, frame.plot=1,col="blue")
plot(means$rk_mean, type="p", xlab= "element size", ylab= "avg. execution time/timestep", main= "Mean execution time for \"RK\" - Titan", pch = 19, cex =0.9, frame.plot=1,col="blue")
...
#       Y-axis: mean execution time per timestep
#pdf("titan-calib-epp100.pdf")
jpeg(file="titan-calib-epp100-sd.jpg", quality=100)

par( mfrow=c(3,2) )
plot(sd$dr_sd, type="p", xlab= "element size",  main= "Std. dev  for \"Dr\" - Titan", pch = 19, cex =1.2, frame.plot=1,col="red")
plot(sd$ds_sd, type="p", xlab= "element size",  main= "Std. dev for \"Ds\" - Titan", pch = 19, cex =1.2, frame.plot=1,col="red")
plot(sd$dt_sd, type="p", xlab= "element size",  main= "Std. dev for \"Dt\" - Titan", pch = 19, cex =1.2, frame.plot=1,col="red")
plot(sd$conv_sd, type="p", xlab= "element size", main= "Std. dev for \"Conv\" - Titan", pch = 19, cex =1.2, frame.plot=1,col="red")
plot(sd$sum_sd, type="p", xlab= "element size",  main= "Std. dev for \"Sum\" - Titan", pch = 19, cex =1.2, frame.plot=1,col="red")
plot(sd$rk_sd, type="p", xlab= "element size",  main= "Std. dev for \"RK\" - Titan", pch = 19, cex =1.2, frame.plot=1,col="red")
