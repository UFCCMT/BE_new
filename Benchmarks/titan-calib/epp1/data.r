...
mainDir <- "/home/legacy/CMT-bone-BE/NGEE/tst-2016/titan-calib/epp1"
outDir <- "titan-out-epp1"
...
#pdf("titan-calib-epp1.pdf")
jpeg(file="titan-calib-epp1-means.jpg", quality=100)
...
#       Y-axis: mean execution time per timestep
#pdf("titan-calib-epp1.pdf")
jpeg(file="titan-calib-epp1-sd.jpg", quality=100)
