...
mainDir <- "/home/legacy/CMT-bone-BE/NGEE/tst-2016/cab-calib/epp1"
outDir <- "cab-out-epp1"
...
#pdf("cab-calib-epp1.pdf")
jpeg(file="cab-calib-epp1-means.jpg", quality=100)
...
#       Y-axis: mean execution time per timestep
#pdf("cab-calib-epp1.pdf")
jpeg(file="cab-calib-epp1-sd.jpg", quality=100)
