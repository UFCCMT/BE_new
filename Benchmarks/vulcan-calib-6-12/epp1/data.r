...
mainDir <- "/home/legacy/CMT-bone-BE/NGEE/tst-2016/vulcan-calib-6-12/epp1"
outDir <- "vul-out-epp1"
...
jpeg(file="vulcan-calib-epp1-means.jpg", quality=100)
...
#       Y-axis: mean execution time per timestep
#pdf("vulcan-calib-epp1.pdf")
jpeg(file="vulcan-calib-epp1-sd.jpg", quality=100)
