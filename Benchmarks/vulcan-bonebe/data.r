...
setwd("/home/legacy/CMT-bone-BE/NGEE/tst-2016/vulcan-bonebe")
...
params <- data[seq(1,nrow(data),3), 2:8]  # 1) input parameter values
...
write.csv(summary, "summary-vulcan-machine.csv", row.names=FALSE)
