...
class matrix_mult(app):
  ...
  def printSubmitSlurmJob(self, tabCount):
    print "\t"*tabCount + "sbatch $1/matrix_mult.out$CUR_MATRIX_SIZE'np'$CUR_NUM_TASKS'.job'"
  ...
  def printSlurmSchedule(self, tabCount):					#TJL: If a lot of this is the same, can moved to a function shared between apps
    ...
    print "\t"*tabCount + 'echo \'#SBATCH --mail-user=aravindneela@ufl.edu\'  >>jobfile            #your email id'
    ...
    print "\t"*tabCount + 'echo \'#SBATCH -o \'$2\'/matrix_mult.out\'$CUR_MATRIX_SIZE\'np\'$CUR_NUM_TASKS\'.out\' >> jobfile'
    print "\t"*tabCount + 'echo \'#SBATCH -e \'$2\'/matrix_mult.out\'$CUR_MATRIX_SIZE\'np\'$CUR_NUM_TASKS\'.err\''' >> jobfile'
    print "\t"*tabCount + 'echo \" " >> jobfile'
    print "\t"*tabCount + 'echo \"module load intel/2016.0.109 openmpi/1.10.2" >> jobfile'
    print "\t"*tabCount + 'echo \" " >> jobfile'
    print "\t"*tabCount + 'echo \"mpirun -np $CUR_NUM_TASKS ./mat_mult.o $CUR_SIZE"'
