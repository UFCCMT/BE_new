import sys
sys.path.insert(0, '/home/legacy/BESimulator/input')
...
cartesianData = cartesian.data8
#cartesianData = input.cartesian.data8
...
Operation( "e5-2670-core", "mm", "cab-matmult-8.csv",
           Loiter( "usage", "==", 0.0),
           Modify( "usage", 1.0 ),
           Dawdle( AnyOutput() ),
           Modify( "usage", 0.0 ) )
