...
cartesianData = input.cartesian.data64
...
Operation( "e5-2670-core", "mm", "cab-matmult-16.csv",
           Loiter( "usage", "==", 0.0),
           Modify( "usage", 1.0 ),
           Dawdle( AnyOutput() ),
           Modify( "usage", 0.0 ) )
...
Operation( "switch", "transfer", "cab-transfer-switch-A.csv",
           Dawdle( AnyOutput() ) )
...
Offspring( "system", Tree( ["switch", "node"], ["ib"], [4] ) )
