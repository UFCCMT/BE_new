...
#TORUS_5D="2,2,2,2,2;4,4,2,2,2;4,4,4,4,2;8,8,4,4,2;8,8,8,8,2;16,16,8,8,2;16,16,16,16,2"

#Test case!
TIMESTEP=1
ELEMENT_SIZE="9" # 13 16" #"8 9 10 11 12"
...
do
  ...
  do
    ...
    do
      ...
      echo "from input.cartesianrank import CartesianGrid" > vul-prop.py
      echo "" >> vul-prop.py
      ...
      echo 'Program( "BGQ-core", "cmt-bone-be.smc" )' >> vul-prop.py
      echo "" >> vul-prop.py
      ...
      #echo 'Attribute( "BGQ-core", "waiting", False )' >> vul-prop.py
      echo 'Operation( "BGQ-core", "wait", NoLookup, 0,
           Recv( True ) )' >> vul-prop.py
      echo 'Operation( "BGQ-core", "unwait", NoLookup, 0,
           Sendb( True ) )' >> vul-prop.py
      echo 'Operation( "BGQ-core", "computeConv", "vulcan-compute-conv.csv", 4,
           Loiter( "usage", "==", 0.0),
           Modify( "usage", 1.0 ),
           Dawdle( AnyOutput() ),
           Modify( "usage", 0.0 ) )' >> vul-prop.py
      echo 'Operation( "BGQ-core", "computedr", "vulcan-compute-dr.csv", 4,
           Loiter( "usage", "==", 0.0),
           Modify( "usage", 1.0 ),
           Dawdle( AnyOutput() ),
           Modify( "usage", 0.0 ) )' >> vul-prop.py
      echo 'Operation( "BGQ-core", "computeds", "vulcan-compute-ds.csv", 4,
           Loiter( "usage", "==", 0.0),
           Modify( "usage", 1.0 ),
           Dawdle( AnyOutput() ),
           Modify( "usage", 0.0 ) )' >> vul-prop.py
      echo 'Operation( "BGQ-core", "computedt", "vulcan-compute-dt.csv", 4,
           Loiter( "usage", "==", 0.0),
           Modify( "usage", 1.0 ),
           Dawdle( AnyOutput() ),
           Modify( "usage", 0.0 ) )' >> vul-prop.py
      echo 'Operation( "BGQ-core", "computeSum", "vulcan-compute-sum.csv", 4,
           Loiter( "usage", "==", 0.0),
           Modify( "usage", 1.0 ),
           Dawdle( AnyOutput() ),
           Modify( "usage", 0.0 ) )' >> vul-prop.py
      echo 'Operation( "BGQ-core", "computerk", "vulcan-compute-rk.csv", 4,
           Loiter( "usage", "==", 0.0),
           Modify( "usage", 1.0 ),
           Dawdle( AnyOutput() ),
           Modify( "usage", 0.0 ) )' >> vul-prop.py
      echo '#Operation( "BGQ-core", "prepareFaces", "vulcan-compute-face-proper.csv", 4,
           #Loiter( "usage", "==", 0.0),
           #Modify( "usage", 1.0 ),
           #Dawdle( AnyOutput() ),
           #Modify( "usage", 0.0 ) )' >> vul-prop.py
      echo 'Mailbox( "BGQ-core", "unwait", lambda source, target, size, tag: [],
         OnTarget )' >> vul-prop.py
      echo 'Component( "BGQ-network" )' >> vul-prop.py
      echo 'Attribute( "BGQ-network", "usage", 0.0 )' >> vul-prop.py
      echo 'Operation( "BGQ-network", "transfer", "vulcan-transfer-512c.csv", 1,
           Loiter( "usage", "==", 0.0),
           Modify( "usage", 1.0 ),
           Dawdle( AnyOutput() ), 
	   Modify( "usage", 0.0 ) )' >> vul-prop.py
