...
class app:
  ...
  def printMoabSchedule(self, tabCount):					#TJL: MOAB/SLURM Schedule print routines can, for the most part, be moved out of the app functions
    print "\t"*tabCount + "#MOAB print schedule not yet defined for this application."
  
  def printSubmitMoabJob(self, tabCount):
    print "\t"*tabCount + "#MOAB submit schedule not yet defined for this application."
  ...
  def printSubmitSlurmJob(self, tabCount):
    print "\t"*tabCount + "#Slurm submit schedule not yet defined for this application."
...
class cmtnek(app):
  appName = "cmt-nek"
  appParamList = ["core_list=\"256\"", "lx1_list=\"20\"", "elpercore_list=\"2\"", "lpartpercore=\"1024\"", "root=`pwd`"]
  auxAppParamList =[""]
  ...
  def printSubmitSlurmJob(self, tabCount):
    print "\t"*tabCount + "sbatch job-${PWD##*/}.job"
  ...
  def printSlurmSchedule(self, tabCount):					#TJL: If a lot of this is the same, can moved to a function shared between apps
    ...
    print "\t"*tabCount + 'echo \'chmod 777 makenek\' > jobfile'
    print "\t"*tabCount + 'echo \'./makenek pvort\' > jobfile'
    print "\t"*tabCount + 'echo \'echo pvort > SESSION.NAME\' > jobfile'
    print "\t"*tabCount + 'echo \'echo `pwd`\'/\' >> SESSION.NAME\' > jobfile'
    print "\t"*tabCount + 'echo \'mkdir profiles\' > jobfile'
    print "\t"*tabCount + 'echo \'#!/bin/bash\' > jobfile'
    ...
    print "\t"*tabCount + 'echo \"#SBATCH --ntasks=256" >> jobfile         			#Number of MPI ranks'
    ...
    print "\t"*tabCount + 'echo \"#SBATCH -t 08:00:00" >> jobfile                         	#Walltime'
    print "\t"*tabCount + 'echo \"#SBATCH --account=ccmt" >> jobfile                             #Account Status'
    print "\t"*tabCount + 'echo \"#SBATCH --qos=ccmt" >> jobfile                                 #QOS'
    ...
    print "\t"*tabCount + 'echo \" " >> jobfile'
    print "\t"*tabCount + 'echo \"mpirun -np 256 ./nek5000 b3dp > log_${PWD##*/}.txt" >> jobfile	#Play that thang'
